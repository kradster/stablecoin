...
import {getSettledLoanData} from '../../Actions/cordaAction';
import Navbar from '../navbar';
import 'react-confirm-alert/src/react-confirm-alert.css';
import * as MessagePop from '../Common/messagePop'


class Sattled extends Component {
    constructor(prop) {
        super(prop);
        this.DEBUG = true;
    ...
    componentWillMount() {
        ...
        // }
        // this.props.getAllEmployees(0);
    }

    componentWillReceiveProps(nextProps){
        if(nextProps.settleLoanData!==undefined && nextProps.settleLoanData.length>0){
         this.setState({emplist:nextProps.settleLoanData});   
        }
                ...
                <div className={"main-container"}>
                    ...
                    <div className="container employee-detials">
                        <div className="h100  mrgt40px">
                            ...
                            <h4 className="col s12 fsz1-5rem grey-text all_mar0">All Settled Loans</h4>
...
const mapPropToState = state => {
    return {
        settleLoanData:state.corda._getSettleLoanData
    }
}

export default connect(mapPropToState, {getSettledLoanData})(Sattled);
